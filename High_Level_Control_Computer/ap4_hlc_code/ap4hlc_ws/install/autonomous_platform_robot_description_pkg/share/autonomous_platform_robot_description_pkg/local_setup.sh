...
: ${AMENT_CURRENT_PREFIX:="/root/ap4_hlc_docker_dir/ap4hlc_ws/install/autonomous_platform_robot_description_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autonomous_platform_robot_description_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autonomous_platform_robot_description_pkg/environment/path.sh"
