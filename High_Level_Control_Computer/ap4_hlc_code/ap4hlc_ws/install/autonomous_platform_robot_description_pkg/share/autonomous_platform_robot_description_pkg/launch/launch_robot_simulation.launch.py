...
def generate_launch_description():
    ...
    slam_config_file = os.path.join(pkg_share, "config", "mapper_params_online_async_simulation.yaml")
    ...
    ekf_node = Node(
        ...
        output="screen",
        parameters=[ekf_config, {"use_sim_time": use_sim_time}, {'odom0':'/odom'}, {'imu0':'/imu'}]
    )
