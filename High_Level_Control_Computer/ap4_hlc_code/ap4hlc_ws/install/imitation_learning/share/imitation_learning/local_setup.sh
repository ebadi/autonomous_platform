...
: ${AMENT_CURRENT_PREFIX:="/root/ap4_hlc_docker_dir/ap4hlc_ws/install/imitation_learning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imitation_learning/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imitation_learning/environment/path.sh"
