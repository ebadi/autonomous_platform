...
2. Source ros2 with: source /opt/ros/humble/setup.bash <- This needs to be done in every new terminal opened
...
2.  Building editor https://classic.gazebosim.org/tutorials?cat=build_world&tut=building_editor 
...
2. ROS Transform system (TF2): https://www.youtube.com/watch?v=QyvHhY4Y_Y8 
3. Creating 3D model of robot with URDF: https://www.youtube.com/watch?v=BcjHyhV0kIs
