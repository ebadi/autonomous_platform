...
3. Continously read the actual position of the motor whilst it is moving to the target position. Wait 1 ms between reading values. From Serial1
4. Write the target position and current position and write to terminal (Serial)
5. Create plots using serial plotter
