...
class TranslatorCANtoROS2Node : public rclcpp::Node
{
  public:
    ...
    : Node("can_ros2_interface_node")
    {
        ...
        */
        ...
        // Frame ID 1500
        publisher_frame_1500_Get_Velocity_ = this->create_publisher<std_msgs::msg::Float64>("/GET_0x5dc_Get_Velocity", 10);
        ...
        */
        ...
        // Frame ID 1500
        subscriber_frame_1500_Get_Velocity_ = this->create_subscription<std_msgs::msg::Float64>("/SET_0x5dc_Get_Velocity", 10, std::bind(&TranslatorCANtoROS2Node::Callback_frame_1500_Get_Velocity, this, std::placeholders::_1));
   ...
   */
    ...
    */
    ...
    void Callback_frame_1500_Get_Velocity(const std_msgs::msg::Float64 msg)
    {
    ...
    */
    ...
    // Frame ID 1500
    rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr publisher_frame_1500_Get_Velocity_;
    ...
    // Frame ID 1500
    rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr subscriber_frame_1500_Get_Velocity_;
