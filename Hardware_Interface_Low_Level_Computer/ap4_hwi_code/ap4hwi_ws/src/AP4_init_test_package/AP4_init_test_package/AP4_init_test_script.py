...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.steering_angle_sub_ = self.create_subscription(Int16, "/GET_0x7d0_Get_SteeringAngle", self.steering_angle_callback, 10)
    ...
    def check_ros_node_is_up(self):
        ...
        list_should_be_up = ["can_ros2_interface_node" , "socket_can_receiver","socket_can_sender"]
    ...
    def check_steering_ok(self):
        ...
        while( (self.get_clock().now() - start_time) < max_wait_time and self.last_steering > -30):
            self.set_steering_angle_pub_.publish(steering_cmd_left)
