...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.publisher_throttle_ = self.create_publisher(UInt16, '/SET_0x3e8_Act_ThrottleVoltage', 10)
        self.publisher_break_ = self.create_publisher(UInt16, '/SET_0x3e8_Act_BreakVoltage', 10)
        self.publisher_steering_position_ = self.create_publisher(Int8, '/SET_0x3e8_Act_SteeringPosition', 10)
